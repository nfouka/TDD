...
class GetPostsListTest extends TestCase
{
    public function test_get_new_and_old_posts()
    {
        ...
        $post1 = new Post('TDD c\'est bien', new \DateTime('2020-10-13'));
        $post2 = new Post('Tester c\'est douter', new \DateTime('2020-10-12'));
        ...
        $this->assertEquals(
            [
                ...
                new PostView('Tester c\'est douter', 1, true ),
            ],
            $getPostsList()
        );
    }
